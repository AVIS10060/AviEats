...
const ItemSection = () => {
  ...
  const isLoading = !currentCity || isItemsLoading
                ...
                <div className="flex items-center justify-between mt-2 w-full ">
                  ...
                  <div className="flex items-center gap-1  border rounded-full overflow-hidden w-[70%]">
                    <button
                      ...
                      className="border-red-50 px-3 text-lg font-semibold"
                    >
                      -
                    </button>

                    <span className="px-3 text-sm">{quantity[item._id] || 0}</span>
                    ...
                    <button
                      onClick={() => {
                        if (!quantity[item._id] || quantity[item._id] <= 0) {
                          toast.error('Add at least one item before adding to cart')
                          return
                        }
                        dispatch(
                          addToCart({
